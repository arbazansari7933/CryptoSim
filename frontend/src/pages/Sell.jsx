...
const Sell = () => {
  ...
  const handleSell = async (e) => {
    ...
    setStatus(null);
    try {
      const res = await api.post("auth/trade/sell", {
        coin,
  ...
  return (
    <Layout>
      <div className="max-w-md mx-auto">
        <div className="mb-8">
          <h1 className="text-lg font-semibold text-white">Sell</h1>
        ...
        <div className="bg-[#0f0f17] border border-white/5 rounded-2xl p-6 space-y-5">
          ...
          <button
            onClick={handleSell}
            disabled={loading}
            className="w-full py-3 rounded-xl text-sm font-semibold transition-all disabled:opacity-50 bg-red-500 hover:bg-red-400 text-white"
          >
